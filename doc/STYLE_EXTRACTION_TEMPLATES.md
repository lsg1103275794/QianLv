...
### 3. 新闻风格提取模板 (`news_style_extraction.yaml`) 🆕
...
| **新闻报道** | `news_style_extraction` | **专业新闻规范，符合行业标准** |
| **媒体稿件** | `news_style_extraction` | **强调客观性和准确性** |
| **时事评论** | `news_style_extraction` | **新闻评论体裁规范** |
| **深度报道** | `news_style_extraction` | **特稿、调查报道等专业体裁** |
| **通讯报道** | `news_style_extraction` | **新闻通讯写作规范** |
...
### v2.1.0 (2024-12-30)
- ✨ 新增新闻风格提取模板 (`news_style_extraction.yaml`)
- 📝 更新文档，添加新闻模板使用说明
- 🎯 支持各类新闻体裁风格分析（消息、通讯、特稿、评论等）
